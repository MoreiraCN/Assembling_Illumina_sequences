...
Meraculous is a easy going algorithm for whole genome assembly of short paired-end reads. The first step of this process was to assembly the whole genome using the filtered reads [GitHub](https://github.com/MoreiraCN/Filtering_Illumina_sequences).

- Command line used:

run_meraculous.sh -c script_assembly_meraculous [GitHub](https://github.com/MoreiraCN/Assembling_Illumina_sequences/blob/main/script_assembly_meraculous)
...
- Command line used: sh script_reassembly_SPAdes [GitHub](https://github.com/MoreiraCN/Assembling_Illumina_sequences/blob/main/script_reassembly_SPAdes.sh)
